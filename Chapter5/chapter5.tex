...
%In some experiments, we also make use of the propagated CityScapes dataset \citep{budvytis2017large}. 
...
%  \caption{Semantic Segmentation labels \citep{Cordts2016Cityscapes} and propagated by \citep{budvytis2017large,budvytis2010label}}
%\end{center}
%\end{subfigure}
